<x-layouts.app title="Subscription Section Management">

    <div class="space-y-8 pb-10">
        <!-- Page Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white font-outfit">Subscription Section Management</h1>
                <p class="text-gray-500 dark:text-gray-400 mt-2">Customize your subscription call-to-action section from here</p>
            </div>
        </div>
        ...
        <div class="glass-card p-8">
            ...
            <!-- Subscription CTA preview -->
            <section class="relative rounded-xl border border-gray-200 dark:border-surface-600 overflow-hidden">
                <!-- Background Gradient -->
                <div class="bg-gradient-to-r from-[#1e3a8a] to-[#1e40af] p-8 md:p-12 text-center">
                    <div class="max-w-4xl mx-auto">
                        ...
                        <!-- Description -->
                        <p class="text-base md:text-lg mb-12 text-white/90 editable-description"
                            data-field="description">
                            {{ $content['description'] ?? 'Discover how our innovative solutions can transform your business and drive sustainable growth.' }}
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <div class="relative group inline-flex">
                                <a href="{{ $content['button_link'] ?? '/contact' }}"
                                   ...
                                   data-field="button_link">
                                    <span class="inline-flex items-center justify-center gap-3 bg-white text-[#1e3a8a] px-8 md:px-12 py-4 md:py-5 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-[#0f172a] hover:text-white transition-all shadow-2xl editable-button-text"
                            ...
                            <a href="/contact"
                                class="inline-flex items-center justify-center gap-3 bg-transparent border-2 border-white text-white px-8 md:px-12 py-4 md:py-5 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-white hover:text-[#1e3a8a] transition-all">
                                Contact Us
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Action Button -->
        <div class="glass-card p-8">
            <form action="{{ route('admin.subscription-section.update') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="flex items-center justify-between">
                ...
                <input type="hidden" name="description" value="{{ $content['description'] ?? 'Discover how our innovative solutions can transform your business and drive sustainable growth.' }}">
                <input type="hidden" name="button_text" value="{{ $content['button_text'] ?? 'Get Started' }}">
        ...
        <div class="glass-card p-8 bg-gradient-to-r from-brand-50 to-blue-50 dark:from-brand-500/10 dark:to-blue-500/10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('admin.contact-cta.index') }}" class="flex items-center gap-3 p-4 bg-white dark:bg-surface-800 rounded-xl hover:shadow-md transition-all">
                    ...
                    <div>
                        <p class="font-bold text-gray-900 dark:text-white">Contact CTA</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Manage contact CTA content</p>
                    </div>
                </a>

                <a href="{{ route('admin.partners.index') }}" class="flex items-center gap-3 p-4 bg-white dark:bg-surface-800 rounded-xl hover:shadow-md transition-all">
                    ...
                    <div>
                        <p class="font-bold text-gray-900 dark:text-white">Partners</p>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Manage partners section</p>
                    </div>
                </a>
        ...
        <div class="bg-white dark:bg-surface-800 rounded-2xl shadow-2xl max-w-lg w-full mx-4">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="cta-button-text" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-surface-600 bg-white dark:bg-surface-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="Get Started">
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Button Link</label>
                    <input type="text" id="cta-button-link" class="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-surface-600 bg-white dark:bg-surface-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-brand-500 focus:border-transparent" placeholder="/contact">
                </div>
    ...
    <x-slot:scripts>
        ...
        <script>
            ...
            function saveCtaButton() {
                ...
                const textFieldInput = document.querySelector(`input[name="${textField}"]`);
                const linkFieldInput = document.querySelector(`input[name="${linkField}"]`);

                if (textFieldInput) {
                    textFieldInput.value = buttonText;
                }
                if (linkFieldInput) {
                    linkFieldInput.value = buttonLink;
                }
