<x-layouts.cms_app title="CMS Admin - Services & Solutions Page" :cmsData="$cmsData">
    ...
    <aside class="cms-sidebar">
        <div class="cms-sidebar-header">
            ...
            <div class="cms-sidebar-subtitle">Services &amp; Solutions Sections</div>
        </div>
                ...
                <div class="cms-nav-content active" id="hero-content">
                    ...
                    <form id="hero-form" class="cms-form" onsubmit="saveSection(event, 'hero')">
                        ...
                        <div class="cms-form-group">
                            ...
                            <input type="text" name="badge" class="cms-form-input" value="{{ $cmsData['hero']['badge'] ?? 'What We Offer' }}">
                        </div>

                        <div class="cms-form-group">
                            <label class="cms-form-label">Main Title (HTML allowed for highlights)</label>
                            <input type="text" name="title" class="cms-form-input" value="{{ strip_tags($cmsData['hero']['title'] ?? 'SERVICES & SOLUTIONS') }}">
                        </div>

                        <div class="cms-form-group">
                            <label class="cms-form-label">Description</label>
                            <textarea name="description" class="cms-form-textarea">{{ $cmsData['hero']['description'] ?? 'Comprehensive engineering services and tailored solutions from concept to commissioning, ensuring your power infrastructure operates at peak performance.' }}</textarea>
                        </div>
        ...
        <div class="cms-header">
            <div>
                <div class="cms-breadcrumb">
                    ...
                    <span>/</span>
                    <span>Services &amp; Solutions CMS</span>
                </div>
                <h1 class="cms-page-title">Services &amp; Solutions Live Preview</h1>
            </div>
        </div>
            ...
            <div class="browser-card">
                <div class="browser-toolbar">
                    ...
                    <div class="browser-address-bar">
                        ...
                        <input type="text" value="http://localhost:5173/preview/services/hero-section" id="url-input" placeholder="Enter preview URL...">
                        <span id="current-section-badge" class="browser-section-badge">Services &amp; Solutions Hero</span>
                    </div>
                ...
                <div class="browser-content">
                    ...
                    <iframe
                        src="http://localhost:5173/preview/services/hero-section"
                        class="browser-iframe"
                        id="browser-iframe"
                        data-default-src="http://localhost:5173/preview/services/hero-section"
                        onload="hideLoading()"
                        onerror="handleError()">
                    </iframe>
                </div>
    ...
    <x-slot:scripts>
        <script>
            ...
            const sectionPreviewUrls = {
                'hero': PREVIEW_BASE_URL + '/preview/services/hero-section'
            };

            const sectionPreviewNames = {
                'hero': 'Services & Solutions Hero'
            };
            ...
            function toggleSection(sectionId) {
                ...
                const previewUrl = sectionPreviewUrls[sectionId] || (PREVIEW_BASE_URL + '/preview/services/' + sectionId);
            ...
            function goHome() {
                ...
                const badge = document.getElementById('current-section-badge');
                showLoading();
                const defaultUrl = PREVIEW_BASE_URL + '/preview/services/hero-section';
                if (iframe) iframe.src = defaultUrl;
                if (urlInput) urlInput.value = defaultUrl;
                if (badge) badge.textContent = 'Services & Solutions Hero';
            }

            function openInNewTab() {
                const urlInput = document.getElementById('url-input');
                const url = urlInput ? urlInput.value : (PREVIEW_BASE_URL + '/preview/services/hero-section');
            ...
            async function saveSection(event, sectionId) {
                ...
                try {
                    const response = await fetch('/admin/cms-section/services-page/' + sectionId, {
                        method: 'POST',
                        body: formData,
                        headers: {
