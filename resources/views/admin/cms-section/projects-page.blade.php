<x-layouts.cms_app title="CMS Admin - Projects Page" :cmsData="$cmsData">
    ...
    <aside class="cms-sidebar">
        <div class="cms-sidebar-header">
            ...
            <div class="cms-sidebar-subtitle">Projects Page Sections</div>
        </div>
                ...
                <div class="cms-nav-content active" id="hero-content">
                    ...
                    <form id="hero-form" class="cms-form" onsubmit="saveSection(event, 'hero')">
                        ...
                        <div class="cms-form-group">
                            ...
                            <input type="text" name="badge" class="cms-form-input" value="{{ $cmsData['hero']['badge'] ?? 'Our Projects' }}">
                        </div>

                        <div class="cms-form-group">
                            <label class="cms-form-label">Main Title (HTML allowed for highlights)</label>
                            <input type="text" name="title" class="cms-form-input" value="{{ $cmsData['hero']['title'] ?? 'BUILDING BANGLADESH' }}">
                        </div>

                        <div class="cms-form-group">
                            <label class="cms-form-label">Description</label>
                            <textarea name="description" class="cms-form-textarea">{{ $cmsData['hero']['description'] ?? 'From mega power projects to renewable energy installations, we deliver engineering excellence that powers the nation.' }}</textarea>
                        </div>
        ...
        <div class="cms-header">
            <div>
                <div class="cms-breadcrumb">
                    ...
                    <span>/</span>
                    <span>Projects Page CMS</span>
                </div>
                <h1 class="cms-page-title">Projects Page Live Preview</h1>
            </div>
        </div>
            ...
            <div class="browser-card">
                <div class="browser-toolbar">
                    ...
                    <div class="browser-address-bar">
                        ...
                        <input type="text" value="http://localhost:5173/preview/projects/hero-section" id="url-input" placeholder="Enter preview URL...">
                        <span id="current-section-badge" class="browser-section-badge">Projects Hero Section</span>
                    </div>
                ...
                <div class="browser-content">
                    ...
                    <iframe
                        src="http://localhost:5173/preview/projects/hero-section"
                        class="browser-iframe"
                        id="browser-iframe"
                        data-default-src="http://localhost:5173/preview/projects/hero-section"
                        onload="hideLoading()"
                        onerror="handleError()">
                    </iframe>
                </div>
    ...
    <x-slot:scripts>
        <script>
            ...
            const sectionPreviewUrls = {
                'hero': PREVIEW_BASE_URL + '/preview/projects/hero-section'
            };

            const sectionPreviewNames = {
                'hero': 'Projects Hero Section'
            };
            ...
            function toggleSection(sectionId) {
                ...
                const previewUrl = sectionPreviewUrls[sectionId] || (PREVIEW_BASE_URL + '/preview/projects/' + sectionId);
            ...
            function goHome() {
                ...
                const badge = document.getElementById('current-section-badge');
                showLoading();
                const defaultUrl = PREVIEW_BASE_URL + '/preview/projects/hero-section';
                if (iframe) iframe.src = defaultUrl;
                if (urlInput) urlInput.value = defaultUrl;
                if (badge) badge.textContent = 'Projects Hero Section';
            }

            function openInNewTab() {
                const urlInput = document.getElementById('url-input');
                const url = urlInput ? urlInput.value : (PREVIEW_BASE_URL + '/preview/projects/hero-section');
            ...
            async function saveSection(event, sectionId) {
                ...
                try {
                    const response = await fetch('/admin/cms-section/projects-page/' + sectionId, {
                        method: 'POST',
                        body: formData,
                        headers: {
