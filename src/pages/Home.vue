    ...
    <section class="py-20 md:py-32 bg-white">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16" v-motion-slide-visible-bottom>
          <div class="flex items-center justify-center gap-3 mb-6">
            <div class="h-px w-12 bg-industrial-blue"></div>
            <span class="text-industrial-blue font-black uppercase tracking-[0.3em] text-[10px] md:text-xs">Our Services</span>
            <div class="h-px w-12 bg-industrial-blue"></div>
          </div>
          <h2 class="text-4xl md:text-5xl font-display font-black uppercase italic mb-6 text-industrial-dark">
    ...
    <section class="py-20 md:py-32 bg-white">
      <div class="max-w-7xl mx-auto px-6">
        <div class="text-center mb-16" v-motion-slide-visible-bottom>
          <div class="flex items-center justify-center gap-3 mb-6">
            <div class="h-px w-12 bg-industrial-blue"></div>
            <span class="text-industrial-blue font-black uppercase tracking-[0.3em] text-[10px] md:text-xs">Testimonials</span>
            <div class="h-px w-12 bg-industrial-blue"></div>
          </div>
          <h2 class="text-4xl md:text-5xl font-display font-black uppercase italic mb-6 text-industrial-dark">
            What Our <span class="text-industrial-blue">Clients Say</span>
          </h2>
          <p class="text-slate-600 text-base md:text-lg max-w-3xl mx-auto">
      ...
      <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
        <div v-motion-slide-visible-bottom>
          <h2 class="text-4xl md:text-5xl font-display font-black uppercase italic mb-8">
            Ready to Power Your <span class="text-yellow-400">Success?</span>
          </h2>
          <p class="text-lg md:text-xl mb-12 text-industrial-100 max-w-3xl mx-auto">
            Let's discuss how Influx Group can deliver the power infrastructure solutions your organization needs. Our team is ready to provide expert consultation and tailored solutions.
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact?type=quote" class="inline-flex items-center justify-center gap-3 bg-white text-industrial-blue px-8 md:px-12 py-4 md:py-5 rounded-sm font-black uppercase tracking-widest text-xs hover:bg-industrial-dark hover:text-white transition-all shadow-2xl">
              Request a Quote <Briefcase class="w-5 h-5" />
            </a>
